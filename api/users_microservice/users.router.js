...
router.post("/", validateSchema("new-user"), create_user);
...
router.post("/account", validateSchema("create-account"), create_account);
router.post("/sign_up", validateSchema("sign-up"), student_employee_sign_up);
router.patch("/", validateSchema("update-user"), update_user);
router.patch("/role", validateSchema("update-role"), update_role);
router.patch("/protected", remove_user_protection);
router.patch("/protected_roles", remove_role_protection);
router.patch("/account", validateSchema("update-account"), update_account);
router.delete("/", delete_users_by_user_ids);
router.delete("/roles", delete_roles_by_role_ids);
